...
public class QuakeSortInPlace {
    ...
    public  ArrayList<QuakeEntry> getQuakeData() {
        ...
        String source = "java3/week1/data/earthquakeDataSampleSix2.xml";
    ...
    public int getLargestDepth(ArrayList<QuakeEntry> quakeData, int from) {
        ...
        for (int i =from+1; i< quakeData.size();i++) {
            ...
            if ( quakeData.get(i).getDepth() > quakeData.get(indDeepest).getDepth() )
                indDeepest=i;
        }
        return indDeepest;
    }
     ...
     * @param quakeData
     * e.g., 200.00, 0.00, -20000.00, -100000.00.
     */
    public void sortByLargestDepth(ArrayList<QuakeEntry> quakeData) {
        ...
        for (int i=0; i<limit; i++) {
            ...
            QuakeEntry quakeMax = quakeData.get(indDeepest);
            quakeData.set(i, quakeMax);
            quakeData.set(indDeepest, currentQuakeEntry);
        }
    }
     ...
     * earthquakes are in sorted order by magnitude from smallest to largest.
     * @param quakes
     * @return
     */
    ...
    public void sortByMagnitudeWithBubbleSortWithCheck(ArrayList<QuakeEntry> in) {
        for (int i=0; i<in.size();i++) {
            if (checkInSortedOrder(in)) {
                System.out.printf("Number of pcheckInSortedOrder asses: %d\n", i);
                break;
            }
            onePassBubbleSort(in, i);
        }
